define(["angularjs", "archdesc/accesspoints.main"], function(angular, application) {
  /*
  *
  *
  ...
  */
	...
	application.controller('LinkCtrl', 
		["$window", "search", '$names', '$rootScope', '$modalInstance', 'q', 
		function($scope, $window, $search, $names, $rootScope, $modalInstance, q) {
	  // Items data
  	...
  	application.controller('LinkerCtrl', 
		["$service", "search", '$dialog', '$names', '$rootScope', '$window', '$modalInstance', 
		function($scope, $service, $search, $dialog, $names, $rootScope, $window, $modal) {
	  /**
